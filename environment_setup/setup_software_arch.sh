...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
# UBC Thunderbots Arch Software Setup
#
...
if ! command -v yay > /dev/null; then
    print_status_msg "Installing yay..."

    # Install prerequisite packages for building AUR packages
    print_status_msg "Installing prerequisites (git, base-devel)..."
    sudo pacman -S --needed --noconfirm git base-devel

    # Create a temporary directory for building yay
    TEMP_DIR="/tmp/yay_install_script"
    mkdir -p "$TEMP_DIR"
    cd "$TEMP_DIR"
    ...
    print_status_msg "yay has been successfully installed."
fi
...
sudo /opt/tbotspython/bin/pip3 install -r arch_requirements.txt
...
install_autoref # TODO maybe arch
