...
class PrimitiveExecutor
{
   ...
   private:
    ...
    // the planned path reaches this far past the point nearest the robot. Larger values
    // are more damped (the robot converges onto the path more gently, less weaving) but
    // cut corners more; smaller values track more tightly but can weave. [s]
